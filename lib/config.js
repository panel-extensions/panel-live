...
// Global auto-run override — set by <panel-live-config> or PanelLive.runAll()
// null = no override (use per-element attribute), true/false = override all elements
export let _autoRunOverride = null;

export function setAutoRunOverride(value) {
  _autoRunOverride = (value === null) ? null : Boolean(value);
}
