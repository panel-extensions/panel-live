...
import { uid, fetchPythonSource } from './utils.js';
import { getCodeFromHash, setCodeInHash } from './url-sharing.js';
  ...
  _renderEditorMode(rt, layout) {
    ...
    let codeHtml = `
      <div class="pl-editor-header">
        ...
        <a class="pl-btn secondary pl-help-link" href="https://github.com/panel-extensions/panel-live" target="_blank" rel="noopener" title="panel-live docs">?</a>
    ...
    if (codeVis === 'hidden') {
      ...
      container.innerHTML = `
        ...
        <div class="pl-code-toggle"><button title="Toggle code visibility">Expand Code</button></div>
        <div class="pl-output-wrapper">
          <div class="pl-status"><span class="pl-spinner"></span> Initializing...</div>
          <div class="pl-output" id="${outputId}"></div>
        </div>
