...
Three POC files were created in the panel monorepo at `panel/live/poc/pyscript/` (historical, not migrated):
...
```
# PyScript POC files (historical, in panel monorepo)
panel/live/poc/pyscript/
